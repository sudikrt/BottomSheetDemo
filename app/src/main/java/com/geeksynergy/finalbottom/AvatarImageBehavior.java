...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, CircleImageView child, View dependency) {
        Log.e ("Dependen : ", String.valueOf(dependency.toString()));
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        ...
        Log.e ("maxScrollDistance :", String.valueOf(maxScrollDistance));
        Log.e ("dependency y :", String .valueOf(dependency.getY()));
        Log.e ("expandedFact :", String .valueOf(expandedPercentageFactor));
        Log.e ("mChangeBehaviorPoint :", String .valueOf(mChangeBehaviorPoint));
